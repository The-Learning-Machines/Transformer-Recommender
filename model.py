...
default_arg.delight_enc_max_depth = 8
...
class SelfAttentionNetwork(Module):
    def __init__(self, opt, n_node):
        ...
        default_arg.delight_enc_layers = opt.layer
        self.transformerEncoder = DeLighTTransformer(opt.hiddenSize, self.n_node, 139, args=default_arg)
...
def train_test(model, train_data, test_data, writer, step):    
    ...
    writer.add_scalar("val/recall", hit, step)
    writer.add_scalar("val/mrr", mrr, step)
    return hit, mrr, step